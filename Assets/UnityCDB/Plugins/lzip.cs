...
public struct fileStat {
    ...
    //
    public static long getFileInfo(string zipArchive, List<string> ninfo, List<long> uinfo, List<long> cinfo, int zipFiles, int zipFolders, string path = null, byte[] FileBuffer = null) {
